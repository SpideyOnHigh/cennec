  ...
  Widget _buildCustomSwitch({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(12),
          color: value ? AppColors.colorDarkBlue : Colors.grey[300],
        ),
        child: AnimatedAlign(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: CommonButton(
                              ...
                              textStyle: getTextStyleFromFont(AppFont.poppins, Dimens.margin16, AppColors.colorOffWhite, FontWeight.w600),
                            ),
                          ),
                          const SizedBox(
