...
//                               printWrapped("refreshed from user detail function");
//                               printWrapped("page nuimber = $pageNumber");
//                               isNavigatedBack = true;
//                               getRecommendations(
//                                   id: updatedRelatedInterest ?? 0,
//                                   pageNumberToCall: 1,
//                                   perPageToCall: (pageNumber > 1 ? pageNumber - 1 : pageNumber) * perPage,
//                                   isNavigateBack: true);
//                             }
//                           },
//                         );
...
//                 child: InkWell(
//                   onTap: () {
//                     getRecommendations(id: updatedRelatedInterest ?? 0, pageNumberToCall: pageNumber, perPageToCall: perPage);
//                   },
//                   child: Visibility(
...
//                         if (pageNumber == 1 && isNavigatedBack) {
...
//                               (value) {
//                             // if (value != null && value == true) {
//                             //   getRecommendations(id: updatedRelatedInterest ?? 0, pageNumberToCall: 1, perPageToCall: pageNumber * perPage);
//                             // }
//                           },
...
//   }
//
//   void getRecommendations({required int id, int? pageNumberToCall, int? perPageToCall, bool? isNavigateBack}) {
//     if (pageNumberToCall == null) {
//       pageNumberToCall = pageNumber;
//       perPageToCall = perPage;
//     }
//     if (isNavigateBack == true) {
//       perPage = (pageNumber > 1 ? pageNumber - 1 : pageNumber) * perPage;
//       pageNumber = 1;
//     }
//     BlocProvider.of<RecommendationsOfInterestBloc>(context)
//         .add(RecommendationsOfInterest(url: "${AppUrls.apiGetRecommendationOfInterest(id)}&per_page=$perPageToCall&page=$pageNumberToCall"));
//   }
//
//   void addRemoveInts() {
